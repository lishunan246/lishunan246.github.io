...
打开VS2013 x64 Native Tools Command Prompt，切换目录,执行`configure.bat -debug-and-release -opensource -confirm-license -mp -opengl desktop -skip qtwebengine -nomake examples -nomake tests`, 等待配置完成。
...
生成文档并安装 `make docs` `make install_docs`
