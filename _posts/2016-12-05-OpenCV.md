...
打开VS2013 x64 Native Tools Command Prompt，切换目录,执行`configure.bat -debug-and-release -opensource -confirm-license -mp`, 等待配置完成。
...
[3.1.0版本的OpenCV不支持Cuda 8.0](https://github.com/opencv/opencv/issues/6677)，不要勾选WITH_CUDA。3.2.0修复了这个问题。
